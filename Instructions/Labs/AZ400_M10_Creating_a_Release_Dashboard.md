...
1.  在 Azure 门户中搜索并选择 **“DevOps Starter”** 资源类型，然后在 **“DevOps Starter”** 边栏选项卡上单击 **“+ 添加”**。 
1.  在 **“DevOps Starter”** 边栏选项卡的 **“使用新应用程序重新开始”** 窗格上，选择 **“.NET”** 磁贴并单击 **“下一步”**。 
1.  在 **“DevOps Starter”** 边栏选项卡上的 **“选择应用程序框架”** 窗格中，选择 **“ASP<nolink>.NET Core”** 磁贴，将 **“添加数据库”** 滑块移动至 **“开启”** 位置，然后单击 **“下一步”**。 
