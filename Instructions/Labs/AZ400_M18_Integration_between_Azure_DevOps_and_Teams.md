...
1.  在模板列表的工具栏中，单击“**专用**”，确保选中“**本地驱动器**”选项，单击“**选择文件**”，在“**打开文件**”中，导航到实验室文件的位置，在 **Allfiles\\18** 文件夹中，选择“**Tailwind Traders.zip**”，单击“**打开**”，然后单击“**提交**”。
1.  返回“**创建新项目**”页面，在“**新建项目名称**”文本框中键入“**Tailwind Traders**”，然后在“**选择组织**”下拉列表中选择你的 Azure DevOps 组织。
1.  在“**创建新项目**”页面上，选择“**是，我要创建此存储库分支**”，单击“**授权**”，出现提示时，使用 GitHub 凭据进行身份验证，单击“**授权 azuredevops-generator-bot**”，如果系统提示安装缺少的扩展，请选择“**ARM 输出**”下面的复选框，然后单击“**创建项目**”。
