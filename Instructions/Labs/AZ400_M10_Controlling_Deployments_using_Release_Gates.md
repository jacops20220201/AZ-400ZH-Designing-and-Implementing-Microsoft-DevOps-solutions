...
1.  等待 Application Insights 资源创建完毕，**然后单击**显示的消息“你的应用已连接到 Application Insights 资源: **“NAME”**” 中的“name”。

    > **备注**： 你将在此处创建监视器警报，并将在本实验室的后续部分使用。 

1.  在 **“Application Insights 资源”** 窗口中，单击 **“监视”** 下的 **“警报选项”**，然后单击 **“+ 新建警报规则”**。
...
1.  在 **“部署后条件”** 窗格中，将 **“入口”** 滑块设置为 **“启用”**，单击 **“+ 添加”**，然后单击弹出窗口中的 **“查询 Azure Monitor 警报”**。
