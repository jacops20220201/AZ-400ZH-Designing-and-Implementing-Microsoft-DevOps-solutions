...
# 实验室：通过使用 DevOps Starter 实现 GitHub Actions
# 学生实验室手册
...
- 通过使用 DevOps Starter 实现 GitHub Actions 工作流
- 说明 GitHub Action 工作流的基本特征
...
1.  在 **“DevOps Starter”** 边栏选项卡的 **“使用新应用程序重新开始”** 页面上，单击 **“单击此处，使用 GitHub 设置 DevOps Starter”** 文本中的 **“此处”** 链接。 
    ...
    > **备注**： 这样会显示 **“DevOps Starter 设置”** 边栏选项卡。 
...
1.  在 **“DevOps Starter”** 边栏选项卡的 **“选择存储库和订阅”** 页面上，单击 **“授权”**。 
    ...
    > **备注**： 这样会显示 **“授权 Azure GitHub Actions”** 弹出 Web 浏览器窗口。

1.  在 **“授权 Azure GitHub Actions”** 弹出窗口中查看所需权限，然后单击 **“授权 AzureGithubActions”**。 

    > **备注**： 这样会将该 Web 弹出浏览器窗口重定向到 Azure DevOps 站点，系统会提示你提供 Azure DevOps 信息。
...
1.  在 **“Deploy_DevOps_Project_az400m08l01\| 概述”** 边栏选项卡上，单击 **“前往资源”**。
...
1.  在 GitHub 存储库页面，单击 **“github/工作流”**，然后单击 **devops-starter-workflow.yml** 条目。
...
1.  将第 20 行更改为 `<div class="description line-1"> GitHub工作流已成功更新</div>`。
1.  向下滚动到页面底部并单击 **“提交更改”**。
1.  在 GitHub 存储库页面的工具栏中单击 **“操作”**。
